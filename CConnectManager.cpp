                              ...
                              const char* szSecret)
{
    ...
    SString strBuffer(_("Patriot GTA"), m_strHost.c_str(), m_usPort);
    CCore::GetSingleton().ShowMessageBox(_("Patriot GTA"), strBuffer, MB_BUTTON_CANCEL | MB_ICON_INFO, m_pOnCancelClick);
    WriteDebugEvent(SString("Patriot GTA", m_strHost.c_str(), m_usPort));
