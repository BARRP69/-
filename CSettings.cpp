...
void CSettings::CreateGUI()
{
    ...
    m_pTabBrowser->SetVisible(false);
    pTabAdvanced->SetVisible(false);
    ...
    m_pSavePasswords->SetVisible(false); 
    ...
    m_pAutoRefreshBrowser->SetVisible(false); 
    ...
    m_pCheckBoxAllowScreenUpload->SetVisible(false); 

    m_pCheckBoxAllowExternalSounds = reinterpret_cast<CGUICheckBox*>(pManager->CreateCheckBox(pTabMultiplayer, _("Разрешить внешние звуки"), true));
    ...
    m_pCheckBoxAllowExternalSounds->SetVisible(false);    

    m_pCheckBoxAlwaysShowTransferBox = reinterpret_cast<CGUICheckBox*>(pManager->CreateCheckBox(pTabMultiplayer, _("Всегда показывать окно загрузки"), false));
    ...
    m_pCheckBoxAlwaysShowTransferBox->SetVisible(false); 
    ...
    m_pMapRenderingLabel->SetVisible(false); 
    ...
    m_pMapAlphaLabel->SetVisible(false); 
