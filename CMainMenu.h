...
public:
    ...
    // Quit confirmation helpers
    static void StaticWantsToQuitCallBack(void* /*pData*/, uint uiButton);
    void        WantsToQuitCallBack(uint uiButton);
    void        AskUserIfHeWantsToQuit();
